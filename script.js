...
// This function now shuffles the answers before displaying them
...
  s  
    // This line shuffles the answer options randomly
    const shuffledAnswers = answersArray.sort(() => 0.5 - Math.random());

    // Loop over the new shuffled array instead of the original
...
s         answerButtonsElement.classList.add('hide');
